...
final class StandLeft extends SpaceManState {
    ...
    public StandLeft(StateMachine<SpaceMan> fsm) {
        super(fsm);
    }
    ...
    protected void setup() {
        System.out.println("stand left up");
        setStateLook(stateImage, stateShape);
    }

    @Override
    protected void teardown() {
        System.out.println("stand left down");
    }
